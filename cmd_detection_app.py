...
# reroute all stdout to this "debug window" I guess.
# this way you at least have some way of seeing the progress.
...
def main(args):
    ...
    events_dir = args[2]
    num_job = '0'
    combined_output_fl = 'psd_out_all.csv'
    rawfiles = [args[0]]  # put single file name in a list to work with loop
    nperm = 500
    is_control = args[3]
...
layout = [
          [sg.Text('Fill in the following:')],
          [sg.Text('Fif File', size=(15, 1)), sg.InputText('')],
          [sg.Text('Output Location', size=(15, 1)), sg.InputText('./model_outfiles/')],
          [sg.Text('Event Folder', size=(15, 1)), sg.InputText('./event_files/')],
          [sg.Checkbox('Is Control')],
          #[sg.ProgressBar(50, orientation='h', size=(20, 20), border_width=4, key='progbar')],
          [sg.Submit(), sg.Cancel()]
         ]

window = sg.Window(title="CMD Detection", layout=layout, margins=(100, 50))
